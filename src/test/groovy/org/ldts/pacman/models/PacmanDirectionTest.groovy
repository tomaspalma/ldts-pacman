...
class PacmanDirectionTest extends Specification {
    ...
    def "We should be able to get correct forward position from down direction"() {
        ...
        expect:
            direction.getPositionToForwardLevel(2) == new Position(pacmanX, pacmanY + 2, arena)
    }
